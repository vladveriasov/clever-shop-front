...
//         try {
//             const result = await axios.get(`https://gainful-judicious-uncle.glitch.me/delivery/${props.deliveryId}`, updatedDelivery);
...
const EditDeliveryForm = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put(`https://gainful-judicious-uncle.glitch.me/delivery/${props.deliveryId}`, updatedDelivery);
            // Handle successful update (e.g., close the modal, refresh the data)
        } catch (exception) {
            console.log("exception:", exception);
        }
