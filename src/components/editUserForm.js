...
//             const result = await axios(`https://gainful-judicious-uncle.glitch.me/user/${props.userEmail}`, { method: "PUT", data: data });
//         };
//         try {
//             dataFetch();
...
const EditUserForm = (props) => {
    ...
    const editUser = () => {
        ...
        const dataFetch = async () => {
            const result = await axios(`https://gainful-judicious-uncle.glitch.me/user/${props.userEmail}`, { method: "PUT", data: data });
            console.log(result) //await axios.put(`https://gainful-judicious-uncle.glitch.me/user/${props.userEmail}`, data);
        };
        try {
            dataFetch();
        } catch (exception) {
